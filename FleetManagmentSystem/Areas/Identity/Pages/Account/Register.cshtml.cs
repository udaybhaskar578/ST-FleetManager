        ...
        public async Task<IActionResult> OnPostAsync(string returnUrl = null)
        {
            ...
            if (ModelState.IsValid)
            {
                ...
                if (result.Succeeded)
                {
                    ...
                    //}
                    //if (!await _roleManager.RoleExistsAsync(Constants.Role_Technician))
                    //{
                    //    await _roleManager.CreateAsync(new IdentityRole(Constants.Role_Technician));
                    //}

                    if (user.Role == null)
                    {
                        await _userManager.AddToRoleAsync(user, Constants.Role_Technician);
                    }
                    else
                    {
